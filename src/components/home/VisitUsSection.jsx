...
const VisitUsSection = () => {
  ...
  return (
    <section className="w-full bg-white py-16 px-4 relative overflow-hidden">
      ...
      <div className="absolute left-0 top-0 w-64 h-64 bg-green-500 opacity-5 rounded-full -ml-32 -mt-32"></div>
      <div className="absolute right-0 bottom-0 w-32 h-32 bg-green-500 opacity-5 rounded-full -mr-16 -mb-16"></div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 md:gap-0">
            ...
            <a 
              ...
              className="inline-flex items-center px-8 py-3 text-lg font-semibold rounded-full bg-green-500 text-gray-800 hover:bg-[#292929] hover:text-white transition-all duration-500 ease-in-out self-start"
            >
              Get Directions
          ...
          {mapError && !isLoading && (
            <div className="w-full h-full flex flex-col items-center justify-center bg-gray-100 p-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2 bg-green-500 text-gray-800 rounded-full font-medium hover:bg-gray-800 hover:text-white transition-colors duration-300"
              >
                Open in Google Maps
              </a>
            </div>
        ...
        <div className="mt-8 p-6 bg-green-50 border border-green-200 rounded-xl flex flex-col md:flex-row md:items-center justify-between">
          ...
          <a 
            href="/events"
            className="inline-flex items-center px-6 py-2 text-base font-medium rounded-full bg-green-500 text-gray-800 hover:bg-[#292929] hover:text-white transition-all duration-300 self-start md:self-center"
          >
            Learn More
            <svg xmlns="http://www.w3.org/2000/svg" className="ml-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
