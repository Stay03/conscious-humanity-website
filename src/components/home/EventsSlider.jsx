...
const EventsSlider = () => {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="h-[480px] md:h-[520px] flex items-center justify-center text-center">
            <div>
              ...
              <Link 
                to="/events" 
                className="inline-flex items-center px-6 py-2 text-sm font-medium rounded-full bg-green-500 text-gray-800 hover:bg-[#292929] hover:text-white transition-all duration-300"
              >
                View All Events
              </Link>
            </div>
  ...
  return (
    <section className="w-full bg-gray-50 py-16 px-4 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute left-0 top-1/4 w-96 h-96 bg-green-500 opacity-5 rounded-full -ml-48"></div>
      <div className="absolute right-0 bottom-0 w-64 h-64 bg-green-500 opacity-5 rounded-full -mr-32 -mb-32"></div>
