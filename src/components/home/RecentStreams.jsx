    ...
    >
      ...
      <div className="relative pt-[56.25%] overflow-hidden bg-gray-200">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center animate-pulse-ring">
      ...
      <div className="flex flex-col flex-grow p-4">
        ...
        <p className="text-green-600 mt-auto">{formattedDate}</p>
      </div>
    </div>
  );
});
...
const RecentStreams = ({ initialVideos = [] }) => {
  ...
  return (
    <>
      ...
      <div className="absolute right-0 top-0 w-64 h-64 bg-green-500 opacity-5 rounded-full -mr-32 -mt-32"></div>
      <div className="absolute left-0 bottom-0 w-32 h-32 bg-green-500 opacity-5 rounded-full -ml-16 -mb-16"></div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <button 
              ...
              className="px-6 py-2 bg-green-500 text-gray-800 rounded-full hover:bg-gray-800 hover:text-white transition-colors"
            >
              Retry
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8">
            ...
            {videos.length > 0 && (
              <div className="relative">
                <div className="absolute top-4 left-4 z-10 bg-green-500 text-gray-900 px-4 py-1 rounded-full font-semibold">
                  Latest Video
                </div>
                <VideoCard 
                  key={videos[0].id} 
