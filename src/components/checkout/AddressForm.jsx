    ...
    >
      <div className="grid grid-cols-1 gap-6">
        ...
        <div>
          ...
          <motion.input
            ...
            className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500 transition-colors duration-200"
            variants={inputVariants}
            whileFocus="focus"
            whileBlur="blur"
          />
      ...
      <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
        ...
        <motion.button
          type="submit"
          disabled={loading}
          className={`px-6 py-3 bg-green-500 text-gray-900 rounded-xl font-semibold shadow-md hover:shadow-lg transition-all duration-200 
