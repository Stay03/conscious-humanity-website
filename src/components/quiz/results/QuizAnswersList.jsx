        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex">
            <div className="relative inline-flex">
              ...
              <select
                className="block w-full pl-10 pr-8 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 bg-white"
                value={filterType}
