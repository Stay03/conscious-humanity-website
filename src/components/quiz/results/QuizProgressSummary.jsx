...
const QuizProgressSummary = ({ 
  ...
  const getScoreRating = (score) => {
    ...
    if (score >= 60) return { label: 'Satisfactory', color: 'text-green-600' };
      ...
      >
        <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 p-6 text-white">
          <div className="flex flex-col items-center">
            ...
            <div className="mt-4 relative">
              ...
              <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-indigo-800 text-white px-3 py-1 rounded-full text-sm font-medium">
                {scoreRating.label}
              </div>
            </div>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-100">
              <div className="flex items-center">
                ...
                <span className="text-sm font-medium text-indigo-900">Time Spent</span>
              </div>
              <div className="mt-2 text-2xl font-bold text-indigo-700">{formatTime(displayTime)}</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            ...
            <div className="p-4 rounded-lg border flex items-start bg-indigo-50 border-indigo-200">
...
>
  ...
  <div className="p-6">
    <div className="space-y-4">
      ...
      <div>
        <h4 className="text-sm font-medium text-gray-700 mb-1 flex items-center">
          <ArrowRight className="h-4 w-4 text-indigo-500 mr-1" />
