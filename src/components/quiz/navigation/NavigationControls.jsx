  ...
  return (
    <div className="flex justify-between items-center">
      ...
      <motion.button
        ...
        className={`inline-flex items-center px-4 py-2 border rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all ${
          isFirstQuestion
      ...
      <motion.button
        ...
        className={`inline-flex items-center px-4 py-2 border rounded-lg shadow-sm text-sm font-medium transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${
          isLastQuestion
            ? 'border-gray-300 bg-gray-100 text-gray-400 cursor-not-allowed'
