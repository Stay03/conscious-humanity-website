    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          ...
          <div className={`p-3 rounded-lg border flex items-start ${fully_graded ? 'bg-green-50 border-green-200' : 'bg-indigo-50 border-indigo-200'}`}>
            <div className={`p-2 rounded-full ${fully_graded ? 'bg-green-100' : 'bg-indigo-100'} mr-3`}>
              <Award className={`h-5 w-5 ${fully_graded ? 'text-green-600' : 'text-indigo-600'}`} />
            </div>
            <div>
              <h4 className={`text-sm font-medium ${fully_graded ? 'text-green-800' : 'text-indigo-800'}`}>
                {fully_graded ? 'Fully Graded' : 'Grading Status'}
              </h4>
              <p className={`text-xs mt-1 ${fully_graded ? 'text-green-700' : 'text-indigo-700'}`}>
