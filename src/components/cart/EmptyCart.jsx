    ...
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <button
          ...
          className="px-6 py-3 bg-green-500 hover:bg-green-600 text-gray-900 font-semibold rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
        >
          Browse Courses
        </button>
        <button
