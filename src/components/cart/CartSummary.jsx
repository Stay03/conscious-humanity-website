...
const CartSummary = ({ cart, onCheckout }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      ...
      <button
        onClick={onCheckout}
        className="w-full mt-6 py-3 px-4 bg-green-500 hover:bg-green-600 text-gray-900 font-semibold rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
      >
        Proceed to Checkout
      </button>
