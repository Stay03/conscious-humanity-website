...
const CourseCard = ({ course }) => {
  ...
  const getPlatformBadgeClass = (platform) => {
    if (platform.toLowerCase().includes('CH')) {
  ...
  const isFree = priceDisplay === 0.00 || priceDisplay ===  "0.00";
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <Link
            ...
            className="inline-flex items-center px-3 py-1.5 bg-green-500 text-gray-900 text-sm font-medium rounded hover:bg-green-600 transition-colors"
          >
            View Course
