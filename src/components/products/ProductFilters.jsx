    ...
    <div className="flex flex-wrap gap-4 items-center">
      ...
      <div className="flex flex-col">
        ...
        <select
          ...
          className="py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 text-sm"
        >
      ...
      <div className="flex items-center gap-2">
        <div className="flex flex-col">
          ...
          <input
            ...
            placeholder="Min"
            className="py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 text-sm w-24"
          />
        </div>
        <div className="flex flex-col">
