...
// Custom toast with green styling to match your application's theme
const customToast = {
  ...
  warning: (message, options = {}) => {
    return toast.warning(message, {
      ...defaultOptions,
      style: { 
        backgroundColor: '#EAB308',  // green background (matching your app's green-500)
  ...
  info: (message, options = {}) => {
    return toast.info(message, {
      ...defaultOptions,
      style: { backgroundColor: '#3B82F6' },  // indigo background
      ...options
    });
  },
