...
import ArtworkBook from '../assets/artworkBook.png'; // Default image for products without thumbnails
    ...
    <div className="w-full">
      ...
      <div className="relative w-full h-[400px] bg-gray-100">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white">            Welcome to Our Online Shop
          </h1>
        </div>
      </div>
      
      {/* Holistic Development Section */}
      <div className="w-full bg-gradient-to-br from-green-50 to-emerald-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
              Here you will find products for your holistic development in all the 5 regions of your life – 
              <span className="font-semibold text-green-700"> Social, Spiritual, Psychological, Physical and Financial</span>. 
              Every technology you find here has been tried, tested and proven to provide you results.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-wrap gap-2 mt-2 md:mt-0">
              ...
              {(filters.search || filters.min_price || filters.max_price) && (
                <button
                  ...
                  className="px-3 py-1 text-sm font-medium text-green-700 hover:text-green-900"
                >
                  Clear All
                </button>
              )}
