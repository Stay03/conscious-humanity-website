      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {error && (
          <div className="mt-6 flex justify-center">
            <button
              onClick={refetch}
              className="px-4 py-2 bg-green-500 text-gray-900 rounded-md hover:bg-green-600 transition-colors"
            >
              Try Again
            </button>
          </div>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <button
                      ...
                      className="mt-4 w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                    >
                      View Details
                    </button>
                  </div>
