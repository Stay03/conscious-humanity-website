    ...
    if (['course', 'ebook'].includes(product.product_type)) {
      ...
      return (
        <button
          ...
          className="w-full py-2 px-4 bg-green-500 hover:bg-green-600 text-gray-900 font-medium rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
        >
    ...
    <div className="max-w-7x mt-20 mb-20 mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {products.length === 0 ? (
        <div className="bg-green-50 border border-green-200 rounded-lg p-8 max-w-3xl mx-auto text-center">
          ...
          <h3 className="text-lg font-medium text-green-800 mb-2">No Items Yet</h3>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => navigate('/courses')}
              className="px-6 py-2 bg-green-500 text-gray-900 font-medium rounded-md hover:bg-green-600 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
            >
              Browse Courses
            </button>
            <button
              ...
              <div key={product.id} className="border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="relative aspect-video bg-gray-200 overflow-hidden">
                  ...
                  <div className="absolute top-2 left-2">
                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${isDigital ? 'bg-indigo-100 text-indigo-800' : 'bg-green-100 text-green-800'}`}>
                ...
                <div className="p-4">
                  ...
                  {isDigital && (
                    <div className="text-sm text-gray-600 mb-4">
                      <span className={`${product.days_remaining < 7 && product.days_remaining > 0 ? 'text-green-600' : product.days_remaining <= 0 ? 'text-red-600' : 'text-gray-600'}`}>
                  ...
                  {!isDigital && (
                    <div className="text-sm text-gray-600 mb-4">
                      <span className={`font-medium ${
                        ...
                        product.status === 'processing' ? 'text-indigo-600' :
