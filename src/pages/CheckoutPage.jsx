        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center bg-white rounded-3xl shadow-lg p-12">
            ...
            <button
              ...
              className="px-8 py-3 bg-green-500 text-gray-900 rounded-xl font-semibold hover:bg-green-600 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
              Continue Shopping
            </button>
          </div>
                  ...
                  <div key={idx} className="flex flex-col items-center">
                    <div 
                      className={`w-16 h-16 rounded-2xl flex items-center justify-center font-bold text-lg transition-all duration-300 ${
                        step >= s.number 
                          ? 'bg-green-500 text-gray-900 shadow-lg transform scale-110' 
                    ...
                    <div className="mt-4 text-center">
                      <p className={`font-semibold ${step >= s.number ? 'text-green-600' : 'text-gray-500'}`}>
                        {s.title}
                      </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-8">
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 resize-none placeholder-gray-400"
                        rows="4"
                      />
                    </div>
                  </div>
            ...
            <div className="mt-12 flex justify-between items-center">
              ...
              {((step === 3 && hasPhysicalItems) || (step === 2 && !hasPhysicalItems)) ? (
                <button
                  ...
                  className="inline-flex items-center px-8 py-3 bg-green-500 text-gray-900 rounded-xl font-semibold shadow-md hover:shadow-lg transform transition-all duration-200 hover:bg-green-600 hover:-translate-y-0.5"
                >
                  Continue to Payment
                ...
                <button
                  ...
                  className="inline-flex items-center px-8 py-3 bg-green-500 text-gray-900 rounded-xl font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5 hover:bg-green-600 transition-all duration-200"
                >
                  Continue
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
