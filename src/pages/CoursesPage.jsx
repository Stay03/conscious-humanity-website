...
import BookImage from '../assets/book.webp'; // Default image for courses without thumbnails
...
const CoursesPage = () => {
  ...
  const initialFilters = {
    platform: queryParams.get('platform') || 'ch',
      ...
      <div className="relative w-full h-[400px] bg-gray-100">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-bold text-white mb-2">Life Empowerment Courses</h1>
