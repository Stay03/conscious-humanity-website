...
const ThreeMysticalTruthPage = lazy(() => import('./pages/ThreeMysticalTruthPage'));
const DonatePage = lazy(() => import('./pages/DonatePage'));
const AboutUsPage = lazy(() => import('./pages/AboutUsPage'));
const PeacePage = lazy(() => import('./pages/PeacePage'));
const ProgramsCoachingPage = lazy(() => import('./pages/ProgramsCoachingPage'));
const GrowingEmpoweredChildPage = lazy(() => import('./pages/GrowingEmpoweredChildPage'));  
const EthereanMissionHospitalPage = lazy(() => import('./pages/EthereanMissionHospitalPage'));
const WellnessCenterPage = lazy(() => import('./pages/WellnessCenterPage'));
const GalleryPage = lazy(() => import('./pages/GalleryPage'));
const LegalPage = lazy(() => import('./pages/LegalDisclaimerPage'));
          ...
          <div className="relative font-questrial">
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/three-mystical-truths" element={<ThreeMysticalTruthPage />} />
                <Route path="/donate" element={<DonatePage />} />
                <Route path="/about" element={<AboutUsPage />} />
                <Route path="/peace" element={<PeacePage />} />
                <Route path="/programs-coaching" element={<ProgramsCoachingPage />} />
                <Route path="/growing-the-empowered-child" element={<GrowingEmpoweredChildPage />} />
                <Route path="/em-hospital-complex" element={<EthereanMissionHospitalPage />} />
...
const NotFound = () => (
  <div className="min-h-screen flex flex-col items-center justify-center text-center px-4">
    ...
    <a 
      href="/"
      className="px-8 py-3 bg-green-500 text-gray-900 font-semibold rounded-full hover:bg-gray-900 hover:text-white transition-colors duration-300"
    >
      Return Home
    </a>
  </div>
